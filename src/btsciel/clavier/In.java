...
/**
 * Cette classe recupere les touches saisies au btsciel.clavier Chaque methode retourne
 * les informations saisies au btsciel.clavier dans le format desire<br>.
 * <hr>
...
public class In {
    ...
    /*
	 * @param in 
	 * c'est une reference sur le flux du btsciel.clavier
     */
     ...
     * sous forme d'entier
     * @exception IOException : probleme avec le btsciel.clavier, declaration
     * @return un entier qui correspond à la valeur tapee sur le btsciel.clavier
     * @exception NumberFormatException si la valeur saisie n'est pas un entier
     */
    public static int readInteger() {
        /*
		 * mot stocke les touches tapees au btsciel.clavier
		 * jusqu'a ce que l'utilisateur appuie sur 
		 * la touche entree du btsciel.clavier
         */
        String mot = null;        
        do {
            try {
			 ...
			 * Si des touches ont ete appuyees
                ...
                System.out.println("Erreur de lecture du btsciel.clavier " + e);
            }
        } while (1 == 1);    
    }
     ...
     * sous forme d'entier
     *
     * @return un entier qui correspond a la valeur tapee sur le btsciel.clavier
     * @exception IOException : probleme avec le btsciel.clavier, declaration
     * @exception NumberFormatException si la valeur saisie n'est pas un entier
     */
     ...
     *
     * @return un double qui correspond a la valeur tapee sur le btsciel.clavier
     * @exception IOException : probleme avec le btsciel.clavier, declaration
     * obligatoire en java
     ...
     *
     * @return un flottant qui correspond a la valeur tapee sur le btsciel.clavier
     * @exception IOException : probleme avec le btsciel.clavier, declaration
     * obligatoire en java
    ...
    public static String readString() //throws Exception
    {
        ...
        try {
            /*
			 * Retourne directemet les touches tapees au btsciel.clavier
            ...
            System.out.println("Erreur de lecture de btsciel.clavier " + e);
        }
        return null;
    }
     ...
     *
     * @return un caratere qui correspond a la valeur tapee sur le btsciel.clavier
     * @exception IOException : probleme avec le btsciel.clavier, declaration
     * @exception NumberFormatException si la valeur saisie n'est pas un
     * caratere
     */
    public static char readChar() //throws Exception
    {
        ...
        try {
            ...
            /*
			 * Si la valeur saisie au btsciel.clavier n'est pas un char,
    ...
    public static char[] readArrayChar()// throws Exception
    {
        ...
        try {
            ...
            /*
			 * Si la valeur saisie au btsciel.clavier n'est pas un byte,
			 * je passe dans ce code
             */
            System.out.println("Vous n'avez pas saisi un entier ");
        }
